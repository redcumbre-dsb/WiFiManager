...
".c,body{text-align:center;font-family:verdana;color:red;}div,input{padding:5px;font-size:1em;margin:5px 0;box-sizing:border-box;}"
...
const char S_brand[]              PROGMEM = "REDCUMBRE SETUP";
...
const char S_titleparam[]         PROGMEM = "Configurar";
